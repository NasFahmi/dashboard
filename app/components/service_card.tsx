...
export default function ServiceCard({ icon: Icon,
    ...
    return (
        ...
        <div className="bg-white w-[230px] flex justify-center gap-3 items-center rounded-[20px] px-[26px] py-[20px]">
            {/* icon */}
            ...
            <div className="whitespace-nowrap">
                ...
                <p className="text-[#718EBF] font-normal text-xs">{description}</p>
            </div>
        </div>
    )
}